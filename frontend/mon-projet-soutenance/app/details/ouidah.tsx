...
export default function OuidahDetailsScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ImageBackground
        source={require('../../assets/images/ouidah.jpg')} // Remplace par ton image
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <Text style={styles.description}>
            Ouidah est une ville côtière chargée d'histoire, connue comme le berceau 
            du vaudou et un important port de la traite négrière. Aujourd'hui, c'est un 
            lieu de pèlerinage spirituel et de mémoire historique.
          </Text>
        ...
        <View style={styles.section}>
          <View style={styles.assistantCard}>
            ...
            >
              ...
              <Text style={styles.assistantTitle}>Questions sur Ouidah ?</Text>
