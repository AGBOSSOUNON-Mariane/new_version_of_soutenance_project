...
export default function GanvieDetailsScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <ImageBackground
          source={require("../../assets/images/ganvie.jpg")}
        ...
        >
          ...
          >
            ...
            <View style={styles.siteHeaderInfo}>
              <Text style={styles.siteName}>Ganvié</Text>
              ...
              <View style={styles.siteStats}>
                ...
                <View style={styles.statItem}>
                  ...
                  <Text style={styles.statText}>2h</Text>
                </View>
              </View>
            </View>
          </LinearGradient>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            <Text style={styles.description}>
              Ganvié, surnommé la "Venise de l'Afrique", est un village lacustre
              unique construit entièrement sur pilotis au milieu du lac Nokoué.
              Ce village de pêcheurs offre une expérience authentique de la vie
              traditionnelle sur l'eau.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.interestPoints}>
              <View style={styles.interestPoint}>
                ...
                <Text style={styles.pointText}>Naissance de Ganvié</Text>
              </View>

              <View style={styles.interestPoint}>
                <View style={styles.pointDot} />
                <Text style={styles.pointText}>Légende du roi Agbogdobé</Text>
              </View>

              <View style={styles.interestPoint}>
                <View style={styles.pointDot} />
                <Text style={styles.pointText}>Mode de vie des habitants de Ganvié </Text>
              </View>

              <View style={styles.interestPoint}>
                <View style={styles.pointDot} />
                <Text style={styles.pointText}>Marché flottant</Text>
              </View>
            </View>
          </View>
            ...
            <View style={styles.assistantCard}>
              ...
              >
                ...
                <Text style={styles.assistantTitle}>
                  Questions sur Ganvié ?
                </Text>
                <Text style={styles.assistantSubtitle}>
                  Notre assistant IA peut vous en dire plus
                </Text>

                <Link href={{ pathname: "../assistant", params: { pole: "Ganvié" } }} asChild>
